...
const App = () => {
  ...
  // const aliceId = AccountId.fromString("0.0.49070890");
  ...
  // const aliceAddress = hethers.utils.getAddressFromAccount(aliceId);
   ...
   const connectContract = async ()=>{
      ...
      // const eoaAccount = {account: signerId,privateKey: `0x${signerKey.toStringRaw()}`, };
      ...
      // const balance = await wallet.getBalance(walletAddress);
        const Address = "0000000000000000000000000000000002ea6ee8";
        const ABI = [
      {
        "inputs": [],
      ...
      },
      {
        ...
        "name": "mintBatchForDiffrentAddress",
        "outputs": [],
        "stateMutability": "nonpayable",
        "type": "function"
      },
      {
        ...
        "name": "mintBatchForSingleAddress",
        "outputs": [],
        "stateMutability": "nonpayable",
        "type": "function"
      },
    ...
    console.log(c)
		console.log(await c.name({gasLimit: 500000}))
  ...
  return (
    ...
    <div>
          ...
          {/* <p>{contractData}</p> */}
          {/* <Button variant="success">Write to contract</Button>{' '} */}
          {/* <Button variant="light">Connect to Hashpack</Button>{' '} */}
